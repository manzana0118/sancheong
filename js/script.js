window.onload = function () {
        ...
        let sw_service = new Swiper(".sw-service", {
            ...
            let submenu_wrap_height = [565, 510, 720, 410, 650, 235];
